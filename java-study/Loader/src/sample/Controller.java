...
public class Controller {
    ...
    public void initialize() {
        System.out.println("Fukcja initialize");
        ...
        lv_classes.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (!lv_methods.getItems().isEmpty()) {
                System.out.println("a");
                lv_methods.getItems().clear();
            }
            if (newValue != null) {
                System.out.println("c");
                findMethodsInClass(newValue);
            }
    ...
    @FXML
    void run() {
        System.out.println("Fukcja void");
        try {
            // private - 2
            // nic - 0
            // public - 1
    ...
    @FXML
    void search() {
        System.out.println("Funkcja clear");
    ...
    @FXML
    void clear() {
        System.out.println("Fukncja clear");
        if (!lv_classes.getItems().isEmpty()) lv_classes.getItems().clear();
    ...
    private void searchClassesWithMethodsWithSignature(String methodName, String signature) throws ClassNotFoundException {
        System.out.println("Suzkanie klasy po signaturze");
    ...
    private void findMethodsInClass(Class clas) {
        System.out.println("Szukanie metoda danej klasy");
    ...
    private static String getSignature(Method m) {
        System.out.println("Pobranie sygnatury");
        String sig;
        try {
    ...
    private void findPackagesWithClasses(String directoryName) {
        ...
        for (File file : fList) {
            if (file.isFile()) {
                ...
                System.out.println(packageWithClassList);
